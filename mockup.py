...
"    ")
        ...
        self.node_painter_filament.setIcon(icon1)
...
"}")
        ...
        self.counter_label = QtWidgets.QLabel(self.tab_info_tab)
        self.counter_label.setGeometry(QtCore.QRect(10, 20, 161, 200))
