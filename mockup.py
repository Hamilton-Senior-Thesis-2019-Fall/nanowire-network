...
"}")
        ...
        self.menuExport_2 = QtWidgets.QMenu(self.menuExport)
        ...
        self.actionCSV_Gephi = QtWidgets.QAction(MainWindow)
        self.actionCSV_Gephi.setObjectName("actionCSV_Gephi")
        self.actionGEXF = QtWidgets.QAction(MainWindow)
        self.actionGEXF.setObjectName("actionGEXF")
        self.menuImport.addAction(self.actionUpload_from_computer)
        self.menuImport.addAction(self.actionUpload_from_saved_projects)
        self.menuExport_2.addAction(self.actionCSV_Gephi)
        self.menuExport_2.addAction(self.actionGEXF)
        self.menuExport.addAction(self.actionSave_file)
        self.menuExport.addAction(self.menuExport_2.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCSV_Gephi.setText(_translate("MainWindow", "CSV (Gephi)"))
        self.actionGEXF.setText(_translate("MainWindow", "GEXF (Cytoscape)"))
